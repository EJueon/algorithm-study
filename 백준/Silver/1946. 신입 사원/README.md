...
### 출력 
 ...
 ### 푸는 방법
 <p>서류 심사 성적과 면접 성적 중 둘 중 하나를 정렬한 후, 차례차례 정렬하지 않은 성적을 살펴본다. max는 마지막 등수로 시작하며, max보다 좋은 성적을 가질 경우, max값을 바꾸어주고 더 안좋은 성적을 가질 경우, 선발하지 않는다.</p>
 
 ### TODO.
 PyPy3로 하면 시간초과가 뜨지 않는데 Python3로 하면 시간초과가 뜬다..
